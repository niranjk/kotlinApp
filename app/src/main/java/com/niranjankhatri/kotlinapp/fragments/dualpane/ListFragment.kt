...
class ListFragment : Fragment(), View.OnClickListener {
    ...
    private lateinit var starSignClickListener: StarSignClickListener

    override fun onAttach(context: Context) {
        super.onAttach(context)
        if( context is StarSignClickListener){
            starSignClickListener = context
        } else {
            throw java.lang.RuntimeException("Must implement StartSignClickListener")
        }
    }
    ...
    override fun onClick(v: View?) {
        v?.let { starSign ->
            starSignClickListener.onClicked(
                starSign.id
            )
        }
    }
