...
class CounterFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val valueTextView = view.findViewById<TextView>(R.id.counter_value)
        val plusBtn = view.findViewById<Button>(R.id.plus)
        val minusBtn = view.findViewById<Button>(R.id.minus)
